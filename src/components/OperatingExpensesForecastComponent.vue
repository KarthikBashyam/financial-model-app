    ...
    <div class="revenue-forecast">
        ...
        <div class="table-container">
            <div class="forecast-assumptions">
                <div class="header">
                    <h4>Input Your Assumptions for Each Expense</h4>
                </div>
    ...
    methods: {
        ...
        async fetchHistoricalData() {
            ...
            const requestBody = {
                ...
                lineItemIds: [8, 9, 13, 67, 68, 69], // Main and growth item IDs
            };
            ...
            try {
                ...
                const sortedData = [];
                const order = [
                    { id: 8, growthId: 67 }, // SG&A Expenses and its growth rate
                    { id: 9, growthId: 68 }, // R&D Expenses and its growth rate
                    { id: 13, growthId: 69 }, // Other Operating Expenses and its growth rate
                ];
        ...
        async submitInputs() {
            try {
                ...
                alert('anySectionExceedsMaxLimit' + this.anySectionExceedsMaxLimit);
