<template>
    <div class="revenue-forecast">
        ...
        <div class="table-container">
            <div class="header">
                <h1>{{ companyHeader }}'s Historical Trend of Operating Expenses</h1>
    ...
    methods: {
        ...
        goForward() {
            ...
            sessionStorage.setItem(
                'userSelections-operatingExpensesForecast',
        ...
        async fetchHistoricalData() {
            ...
            const requestBody = {
                ...
                lineItemIds: [3, 4, 28, 34, 35, 36], // Main and growth item IDs
            };
